...
(function(){
  const STORE_PREFIX = 'levi-highlights::';
  ...
  function onTooltipClick(event){
    ...
    if(btn.dataset.action === 'note'){
      persistHighlight(offsets.start, offsets.end, selectedText);
      applyHighlights(loadHighlights());
      window.LEVI_NOTES_API?.append(selectedText, {lessonTitle: document.body.dataset.title || getPageKey(), timestamp: new Date().toLocaleString('it-IT', {dateStyle:'short', timeStyle:'short'})});
    }
